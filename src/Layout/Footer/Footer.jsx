...
const Footer = () => {
    return (
        <footer className="footer footer-center p-10 bg-primary text-primary-content">
            ...
            <div>
                <Link to='/'><img src="/zyro-image.ico" alt="" /></Link>
                <p className="font-bold">
                Action Avenue Ltd. <br/>Providing reliable toys since 1992
                </p> 
            </div> 
            <div>
                <p className='md:text-lg'>Copyright © 2023 - All right reserved by Shamim Sikder</p>
            </div>
        </footer>
    );
};
